...
vim.keymap.set('n', '<C-/>', builtin.current_buffer_fuzzy_find, { desc = 'Telescope: Fuzzy find in current buffer' })
-- Alternative:
...
-- ============================================================
vim.keymap.set('n', '<leader>fd', '<cmd>Telescope dir live_grep<CR>',  { noremap = true, silent = true, desc = 'Telescope dir: Live grep (pick dir)' })
vim.keymap.set('n', '<leader>pd', '<cmd>Telescope dir find_files<CR>', { noremap = true, silent = true, desc = 'Telescope dir: Find files (pick dir)' })
...
vim.keymap.set('n', '<leader>ic', builtin.lsp_incoming_calls,     { desc = 'LSP: Show [I]ncoming [C]alls' })
vim.keymap.set('n', '<leader>oc', builtin.lsp_outgoing_calls,     { desc = 'LSP: Show [O]utgoing [C]alls' })

-- Symbols
vim.keymap.set('n', '<leader>ls',   builtin.lsp_document_symbols,          { desc = '[L]ist [S]ymbols in buffer' })
vim.keymap.set('n', '<leader>lsw',  builtin.lsp_workspace_symbols,         { desc = '[L]ist [S]ymbols in [W]orkspace' })
vim.keymap.set('n', '<leader>lsww', builtin.lsp_dynamic_workspace_symbols, { desc = '[L]ist [S]ymbols in [W]orkspace (dynamic)' })

-- Diagnostics (NOTE: your mapping calls workspace symbols; keeping as-is but labeled clearly)
vim.keymap.set('n', '<leader>ld', builtin.lsp_dynamic_workspace_symbols, { desc = '[L]ist [D]iagnostics (check mapping)' })
...
-- ============================================================
vim.keymap.set('n', '<leader>r', ':NvimTreeToggle<CR>', { noremap = true, desc = 'NvimTree: Toggle' })
...
vim.keymap.set('n', '<C-p>',   '<Cmd>BufferLineCyclePrev<CR>', { desc = 'BufferLine: Previous buffer' })
vim.keymap.set('n', '<C-S-n>', '<Cmd>BufferLineMoveNext<CR>',  { desc = 'BufferLine: Move buffer forward' })
vim.keymap.set('n', '<C-S-p>', '<Cmd>BufferLineMovePrev<CR>',  { desc = 'BufferLine: Move buffer back' })

-- Close buffers
vim.keymap.set('n', '<leader>q',  '<Cmd>bdelete<CR>',              { desc = 'Close current buffer' })
vim.keymap.set('n', '<leader>bc', '<cmd>BufferLinePickClose<CR>',  { desc = 'BufferLine: Pick buffer to close' })
...
-- Shows bookmark list.
-- ============================================================
vim.keymap.set('n', '<leader>mm', '<cmd>Telescope bookmarks list<CR>', { noremap = true, silent = true, desc = 'Bookmarks: List (Telescope)' })
